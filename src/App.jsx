    ...
    <BrowserRouter>
      <div className="App">        
        <Routes>
          ...
          <Route path="/approverhome" element={<LoanApproverHome />} />
          <Route path="/addloanapprover" element={<AddLoanApprover name={'AddLoanApprover'}/>} />
          <Route path="/updateloanapprover" element={<UpdateLoanApprover />} />
          <Route path="/deleteloanapprover" element={<DeleteLoanApprover name={'DeleteLoanApprover'}/>} />
